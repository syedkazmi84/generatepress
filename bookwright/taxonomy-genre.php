...
<section class="bw-page-hero">
	<div class="bw-wrap">
		...
		<h1><?php echo esc_html( $term ? $term->name : __( 'Category', 'bookwright' ) ); ?></h1>
		<p><?php echo esc_html( $term && $term->description ? $term->description : __( 'Projects in this category from our portfolio.', 'bookwright' ) ); ?></p>
	</div>
</section>
...
<section class="bw-section">
	<div class="bw-wrap">
		<div class="bw-center" style="margin-bottom:44px;display:flex;gap:10px;flex-wrap:wrap;justify-content:center;">
			<a class="bw-badge-soft" href="<?php echo esc_url( get_post_type_archive_link( 'book' ) ); ?>"><?php esc_html_e( 'All work', 'bookwright' ); ?></a>
			<?php
